...
public class ExampleVisualRecognition : MonoBehaviour
{
    ...
    private string _imageURL = "https://www.uni-regensburg.de/Fakultaeten/phil_Fak_II/Psychologie/Psy_II/beautycheck/english/durchschnittsgesichter/m(01-32).jpg";
#if TRAIN_CLASSIFIER
